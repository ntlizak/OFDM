function varargout = symulacja_OFDM_v2(varargin)
% SYMULACJA_OFDM_V2 MATLAB code for symulacja_OFDM_v2.fig
%      SYMULACJA_OFDM_V2, by itself, creates a new SYMULACJA_OFDM_V2 or raises the existing
%      singleton*.
%
%      H = SYMULACJA_OFDM_V2 returns the handle to a new SYMULACJA_OFDM_V2 or the handle to
%      the existing singleton*.
%
%      SYMULACJA_OFDM_V2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SYMULACJA_OFDM_V2.M with the given input arguments.
%
%      SYMULACJA_OFDM_V2('Property','Value',...) creates a new SYMULACJA_OFDM_V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before symulacja_OFDM_v2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to symulacja_OFDM_v2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help symulacja_OFDM_v2

% Last Modified by GUIDE v2.5 24-Jun-2014 14:54:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @symulacja_OFDM_v2_OpeningFcn, ...
                   'gui_OutputFcn',  @symulacja_OFDM_v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before symulacja_OFDM_v2 is made visible.
function symulacja_OFDM_v2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to symulacja_OFDM_v2 (see VARARGIN)

% Choose default command line output for symulacja_OFDM_v2
...
% UIWAIT makes symulacja_OFDM_v2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = symulacja_OFDM_v2_OutputFcn(hObject, eventdata, handles) 
